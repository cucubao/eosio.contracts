...
namespace eosiosystem {
   ...
   struct [[eosio::table("global"), eosio::contract("eosio.system")]] eosio_global_state : eosio::blockchain_parameters {
      ...
      time_point           last_pervote_bucket_fill;  //上回发起计算收益的时间
      int64_t              pervote_bucket = 0;     //得票奖励池
      int64_t              perblock_bucket = 0;    //出块奖励池
   ...
   struct [[eosio::table, eosio::contract("eosio.system")]] producer_info {
      ...
      bool                  is_active = true;
      std::string           url;
      uint32_t              unpaid_blocks = 0;  //已生产但未支付的块
      time_point            last_claim_time;    //上次领奖时间
      uint16_t              location = 0;
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name saving_account{"eosio.saving"_n}; //EOS基金池
